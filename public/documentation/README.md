...
- update settings slider props

### 1.1.24

- hello world: Add better UI for text alignment

### 1.1.25

- hello world: add better comments, and more clear descriptions
